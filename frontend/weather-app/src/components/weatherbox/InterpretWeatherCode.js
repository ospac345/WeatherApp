...
function InterpretWeatherCode(weatherCode) {
    ...
    if (!weatherInfo) {
        return {
            dayIcon: null,
            nightIcon: null,
            weatherTextDay: 'Unknown Weather',
            weatherTextNight: 'Unknown Weather'
        };
    }

    return {
        dayIcon: weatherInfo.day.image,
        nightIcon: weatherInfo.night.image,
        weatherTextDay: weatherInfo.day.description,
        weatherTextNight: weatherInfo.night.description
    };
}
